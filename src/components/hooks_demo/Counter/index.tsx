...
const useCounter = (v: number) => {
    ...
    const handleOverrideCount = (v: number) => useCallback(() => setCount(v), [count])

    return {count, double, handleAddCount, handleResetCount, handleOverrideCount}
}

export const Counter: React.FC = () => {
    const {count, double, handleAddCount, handleResetCount, handleOverrideCount} = useCounter(0)
